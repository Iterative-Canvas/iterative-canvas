import { useQueries, OptionalRestArgsOrSkip } from "convex/react"
import {
  FunctionReference,
  FunctionReturnType,
  getFunctionName,
...
// https://github.com/get-convex/convex-helpers/tree/main/packages/convex-helpers#richer-usequery
